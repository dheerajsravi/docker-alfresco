...
```bash
docker pull dheerajsravi/alfresco:1.0
```


Alternatively, you can build the image yourself:
```bash
git clone https://github.com/dheerajsravi/docker-alfresco.git
cd docker-alfresco
...
```bash
docker run --name='alfresco' -it --rm -p 8080:8080 dheerajsravi/alfresco:1.0
```
